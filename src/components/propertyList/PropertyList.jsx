...
const PropertyList = () => {
    return (
        <div className="pList">
            ...
            <div className="pListItem">
                <img src="https://t-cf.bstatic.com/static/img/theme-index/carousel_320x240/card-image-chalet_300/8ee014fcc493cb3334e25893a1dee8c6d36ed0ba.jpg" alt="" className="pListImg" />
                <div className="pListTitles">
                    <h1>Cabins</h1>
                    <h2>332 cabins</h2>
                </div>
